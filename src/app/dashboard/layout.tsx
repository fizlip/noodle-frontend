...
const LayoutMain: React.FC<Props> = ({children}) => {
  ...
  return(
    <div>
      ...
      <div className="flex">
        <div className="relative group z-0" onMouseEnter={() => {if(window.innerWidth >= 680){setMouseHover(true)}}} onMouseLeave={() => setMouseHover(false)}>
          <Sidebar>
            ...
            <SidebarComponent mouseHover={mouseHover} icon={<MdOutlineDashboard size={ICON_SIZE} />} title="Dashboard" href="/dashboard" />
            <SidebarComponent mouseHover={mouseHover} icon={<GiFastNoodles size={ICON_SIZE}/>} title="Noodles" href="/settings"/>
            <SidebarComponent mouseHover={mouseHover} icon={<IoStorefront size={ICON_SIZE}/>} title="Marketplace" href="/settings"/>
            <SidebarComponent mouseHover={mouseHover} icon={<RiHistoryFill size={ICON_SIZE}/>} title="History" href="/system"/>
          </Sidebar>
        </div>
        <div className="w-[100%]">
          {children}
